...
| [**TURBO**](https://github.com/riju-talk/TURBO) | Independent implementation of Target Augmented Shared Fusion based Multimodal Sarcasm Explanation. Detects sarcasm, identifies targets, and fuses text and image inputs via modified BART encoder with cross attention and Vision Transformer features. Evaluates on MORE+ dataset with BLEU, ROUGE, and METEOR. |

### Full Stack Applications

| Project | Description |
|---------|-------------|
| [**DreamDOT**](https://github.com/riju-talk/DreamDOT) | Next gen social media and blogging platform that empowers creators to publish, connect, and earn through dynamic subscriptions, pay per view content, and immersive community interaction. |
| [**Flourish**](https://github.com/riju-talk/Flourish) | Smart plant care web application that bridges the gap between wanting to keep plants alive and actually knowing how. Uses real horticultural data combined with artificial intelligence. |
